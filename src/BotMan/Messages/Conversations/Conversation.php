...
namespace Duke\Horizon\BotMan\Messages\Conversations;

use Duke\Horizon\BotMan\BotMan;
use Duke\Horizon\BotMan\Interfaces\ShouldQueue;
...
abstract class Conversation
{
    ...
    /**
     * @param string|\BotMan\Messages\Outgoing\Question $question
     * @param array|Closure $next
    ...
    /**
     * @param string|\BotMan\Messages\Outgoing\Question $message
     * @param array $additionalParameters
     * @return $this
     */
