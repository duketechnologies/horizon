...
namespace Duke\Horizon\BotMan\Messages\Outgoing;

use Duke\Horizon\BotMan\Interfaces\QuestionActionInterface;
use Duke\Horizon\BotMan\Interfaces\WebAccess;
use Duke\Horizon\BotMan\Messages\Outgoing\Actions\Button;
...
class Question implements JsonSerializable, WebAccess
{
    ...
    /**
     * @param \BotMan\Messages\Outgoing\Actions\Button $button
     * @return $this
     */
