...
return [
    ...
    */
    ...
    'custom' => [
        'phone_unique' => 'Упс, мұндай нөмірі бар пайдаланушы қазірдің өзінде тіркелген.',
        'phone_exist' => 'Упс, бұл телефон бізде тіркелмеген.'.PHP_EOL.'Тіркеуден өтуіңізді сұраймыз.',
